...
/*   Updated: 2025/08/20 19:09:45 by stanaka2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			ft_reset_conversion(t_dprintf_ctx *ctx);
bool			ft_read_conversion(
					va_list *ap, const char **format, t_dprintf_ctx *ctx);
...
void			ft_conv_p(va_list *ap, t_dprintf_ctx *ctx);
void			ft_conv_percent(t_dprintf_ctx *ctx);
// extra (%o, %n, %f, %e, %g, %a, %Lf, %Le, %Lg, %lc, %ls)
void			ft_conv_o(va_list *ap, t_dprintf_ctx *ctx);
void			ft_conv_f_e_g(va_list *ap, t_dprintf_ctx *ctx);
...
void			ft_conv_e_binary64(va_list *ap, t_dprintf_ctx *ctx);
void			ft_conv_f_binary64(va_list *ap, t_dprintf_ctx *ctx);
...
void			ft_print_g_exp_notation_binary64(t_dprintf_ctx *ctx,
					t_my_double *my_double, int decimal_exponent);
void			ft_print_g_fixed_point_binary64(t_dprintf_ctx *ctx,
					t_my_double *my_double, int decimal_exponent);
...
void			ft_conv_f_80bit(va_list *ap, t_dprintf_ctx *ctx);
void			ft_conv_g_80bit(va_list *ap, t_dprintf_ctx *ctx);
...
void			ft_print_g_exp_notation_80bit(t_dprintf_ctx *ctx,
					t_my_double *my_double, int decimal_exponent);
void			ft_print_g_fixed_point_80bit(t_dprintf_ctx *ctx,
					t_my_double *my_double, int decimal_exponent);
...
void			ft_conv_ls(va_list *ap, t_dprintf_ctx *ctx);
