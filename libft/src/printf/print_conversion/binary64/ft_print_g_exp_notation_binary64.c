...
static int		ft_get_printable_precision_exp_notation(t_printf_ctx *ctx,
					t_my_double *my_double, int decimal_exp);
static size_t	ft_get_length_g_exp_notation(t_printf_ctx *ctx,
					t_my_double *my_double, int decimal_exp);
static void		ft_print_g_exp_notation_non_negative_exp(t_printf_ctx *ctx,
					t_my_double *my_double, int decimal_exp);
static void		ft_print_g_exp_notation_negative_exp(t_printf_ctx *ctx,
					t_my_double *my_double, int decimal_exp);

void	ft_print_g_exp_notation_binary64(
				...
				t_printf_ctx *ctx, t_my_double *my_double, int decimal_exp)
{
	...
	if (decimal_exp > 0)
	{
		...
		while (precision < ctx->precision && i < PF_DBL_INT)
		{
			precision++;
