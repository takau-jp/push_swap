...
/*   Updated: 2025/08/20 19:00:22 by stanaka2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_dprintf.h"

static void		ft_print_o(t_dprintf_ctx *ctx, uintmax_t num);
static size_t	ft_get_digits_uintmax_octal(uintmax_t num);
static void		ft_print_octal(t_dprintf_ctx *ctx, uintmax_t num);
...
static void	ft_print_octal(t_dprintf_ctx *ctx, uintmax_t num)
{
	...
	ft_dprint_char(ctx, "01234567"[num % 8]);
}
