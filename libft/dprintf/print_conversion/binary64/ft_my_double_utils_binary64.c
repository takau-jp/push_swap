...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_my_double_utils_binary64_bonus.c                :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: stanaka2 < stanaka2@student.42tokyo.jp>    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/06/02 17:08:32 by stanaka2          #+#    #+#             */
/*   Updated: 2025/06/30 14:31:23 by stanaka2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool	ft_init_my_double(t_my_double *my_double)
{
	...
	my_double->decimal_int = ft_calloc(PF_DBL_INT, sizeof(uint8_t));
	if (!my_double->decimal_int)
		return (false);
	my_double->decimal_frac = ft_calloc(PF_DBL_FRAC, sizeof(uint8_t));
