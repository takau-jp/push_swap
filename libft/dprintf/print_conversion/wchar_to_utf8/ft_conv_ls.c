...
/*   Updated: 2025/08/20 19:03:08 by stanaka2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_dprintf.h"

static void		ft_print_null(t_dprintf_ctx *ctx);
static void		ft_print_ls(t_dprintf_ctx *ctx, const wchar_t *ws);
static size_t	ft_encode_wchar_str_to_utf8(t_dprintf_ctx *ctx,
