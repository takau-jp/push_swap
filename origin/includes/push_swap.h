...
/*   Updated: 2025/09/28 14:50:37 by stanaka2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef struct s_restore {
	...
	size_t		chunk_insertion_cost;
	ssize_t		rra_cost_to_max_insert_position;
}	t_restore;
...
typedef struct s_ctx {
	...
	size_t		min_chunk_element_index;
	size_t		max_pushed_element_index;
	size_t		chunk_insertion_cost;
	ssize_t		rra_cost_to_max_insert_position;
	t_restore	restore;
